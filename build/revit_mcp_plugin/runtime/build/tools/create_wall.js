...
export function registerCreateWallTool(server) {
    server.tool("create_wall", "Create walls in the Revit model. Create walls with start/end points, height, thickness, level, and type. All units in mm.\n在 Revit 中创建墙体。支持通过起点/终点、高度、厚度、标高和类型创建墙体。所有单位为毫米。", {
