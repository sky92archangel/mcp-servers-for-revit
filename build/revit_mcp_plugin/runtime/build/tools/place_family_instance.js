...
export function registerPlaceFamilyInstanceTool(server) {
    server.tool("place_family_instance", "Place a family instance by FamilySymbol ID with support for unhosted, hosted, face-based, and workplane placement. Optional rotation. All units in mm.\n通过 FamilySymbol ID 放置族实例，支持无宿主、有宿主、基于面和基于工作平面的放置。可选旋转。所有单位为毫米。", {
