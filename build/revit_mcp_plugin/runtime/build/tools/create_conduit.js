...
export function registerCreateConduitTool(server) {
    server.tool("create_conduit", "Create conduits in the Revit model. Supports conduits with start/end points, diameter, and level. All units in mm.\n在 Revit 中创建线管。支持设置起点/终点、直径和标高。所有单位为毫米。", {
