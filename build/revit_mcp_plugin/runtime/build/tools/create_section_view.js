...
export function registerCreateSectionViewTool(server) {
    server.tool("create_section_view", "Create a section view in Revit with bounding box and view family type. All units in mm. / 在Revit中创建带有边界框和视图族类型的剖面视图。所有单位为毫米。", {
