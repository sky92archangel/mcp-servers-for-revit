...
export function registerCreateModelCurveTool(server) {
    server.tool("create_model_curve", "Create model curves in the Revit model. Supports lines and arcs with start/end points, curve type, and sketch plane level. All units in mm.\n在 Revit 中创建模型线。支持直线和弧线，可设置起点/终点、曲线类型和草图平面标高。所有单位为毫米。", {
