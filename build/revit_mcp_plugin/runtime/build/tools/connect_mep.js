...
export function registerConnectMepTool(server) {
    server.tool("connect_mep", "Connect two MEP elements via their connectors. Supports direct, elbow, tee, reducer, and cross connections.\n通过连接器连接两个 MEP 图元。支持直接连接、弯头、三通、变径和十字连接。", {
