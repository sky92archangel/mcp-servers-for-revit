...
export function registerSetViewRangeTool(server) {
    server.tool("set_view_range", "Set the view range of a plan view in Revit (top, cut plane, bottom, view depth). All units in mm. / 在Revit中设置平面视图的视图范围（顶部、剖切面、底部、视图深度）。所有单位为毫米。", {
