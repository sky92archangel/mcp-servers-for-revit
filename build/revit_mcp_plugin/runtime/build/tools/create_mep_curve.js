...
export function registerCreateMEPCurveTool(server) {
    server.tool("create_mep_curve", "Create MEP curves in Revit (duct/pipe/conduit). All units in mm. / 在Revit中创建MEP曲线（风管/管道/线管）。所有单位为毫米。", {
