...
export function registerCreateDuctTool(server) {
    server.tool("create_duct", "Create ducts in the Revit model. Supports rectangular and round ducts with start/end points, width, height, system type, and level. All units in mm.\n在 Revit 中创建风管。支持矩形和圆形风管，可设置起点/终点、宽度、高度、系统类型和标高。所有单位为毫米。", {
