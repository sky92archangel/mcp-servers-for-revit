...
export function registerCreateRoofTool(server) {
    server.tool("create_roof", "Create roofs in the Revit model. Supports flat, gable, and hip roofs with level, thickness, slope, overhang, and material. All units in mm.\n在 Revit 中创建屋顶。支持平屋顶、双坡屋顶和四坡屋顶，可设置标高、厚度、坡度、挑檐和材质。所有单位为毫米。", {
