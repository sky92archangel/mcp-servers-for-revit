...
export function registerCreateMepSystemTool(server) {
    server.tool("create_mep_system", "Create MEP systems (mechanical or piping) and assign elements to them. Supports supply air, return air, exhaust air, sanitary, hydronic supply, and hydronic return.\n创建 MEP 系统（机械或管道）并将图元分配给系统。支持送风、回风、排风、排污、供热供水、供热回水。", {
