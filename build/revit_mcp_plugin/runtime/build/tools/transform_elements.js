...
export function registerTransformElementsTool(server) {
    server.tool("transform_elements", "Move, copy, rotate, or mirror Revit elements. Returns new element IDs for copy operations. / 移动、复制、旋转或镜像Revit图元。复制操作返回新图元ID。", {
