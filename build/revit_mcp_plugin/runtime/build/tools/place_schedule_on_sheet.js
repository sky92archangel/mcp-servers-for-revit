...
export function registerPlaceScheduleOnSheetTool(server) {
    server.tool("place_schedule_on_sheet", "Place a schedule view onto a sheet in Revit. All coordinates in mm. / 在Revit中将明细表视图放置到图纸上。所有坐标单位为毫米。", {
