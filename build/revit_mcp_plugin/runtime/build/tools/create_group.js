...
export function registerCreateGroupTool(server) {
    server.tool("create_group", "Create element groups in the Revit model. Groups selected elements by their IDs with a specified group name.\n在 Revit 中创建图元组。通过指定的图元 ID 列表和组名称创建图元组。", {
