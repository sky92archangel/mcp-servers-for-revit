...
export function registerManageViewFiltersTool(server) {
    server.tool("manage_view_filters", "Add or remove view filters in Revit and optionally set graphic overrides. / 在Revit中添加或移除视图过滤器，并可选择设置图形覆盖。", {
