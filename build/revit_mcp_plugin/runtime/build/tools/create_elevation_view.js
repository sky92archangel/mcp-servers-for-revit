...
export function registerCreateElevationViewTool(server) {
    server.tool("create_elevation_view", "Create an elevation view in Revit using an elevation marker. Direction index 0-3 maps to project north/south/east/west. / 在Revit中使用立面标记创建立面视图。方向索引0-3对应项目北/南/东/西。", {
