...
export function registerCreateRevisionCloudTool(server) {
    server.tool("create_revision_cloud", "Create a revision cloud in a Revit view with boundary points. All coordinates in mm. / 在Revit视图中创建带有边界点的修订云线。所有坐标单位为毫米。", {
