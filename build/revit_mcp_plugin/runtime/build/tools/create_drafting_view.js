...
export function registerCreateDraftingViewTool(server) {
    server.tool("create_drafting_view", "Create a drafting view in Revit with custom name, scale, and detail level. / 在Revit中创建带有自定义名称、比例和详细程度的绘图视图。", {
