...
| 44 | `manage_family_parameters` | ⚠️ 未测 | 需要在族文档中测试 |
| 45 | `load_family` | ⚠️ 未测 | 需要族文件路径 |
| 46 | `place_family_instance` | ⚠️ 未测 | 需要族类型 ID |
...
- **未测工具**: 约 22 个工具因依赖已有图元/族类型/文件路径而未测试, 需要更完善的项目环境
